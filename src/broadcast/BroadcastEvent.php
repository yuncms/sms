...
{
    /**
     * @var \yuncms\broadcast\BroadcastInterface the broadcast message being send.
     */
    public $message;
     ...
     * [[\yuncms\broadcast\BaseBroadcast::EVENT_BEFORE_SEND]] may set this property to decide whether
