...
<div class="col-md-6 col-md-offset-3">
    ...
    <div class="alert alert-info">
        <p>
            <?= Yii::t('yuncms', 'In order to finish your registration, we need you to enter following fields') ?>
            :
        </p>
    </div>
    ...
    <?= Html::submitButton(Yii::t('yuncms', 'Continue'), ['class' => 'btn btn-success btn-block']) ?>

    <?php ActiveForm::end(); ?>
    <p class="text-center">
        <?= Html::a(Yii::t('yuncms', 'If you already registered, sign in and connect this account on settings page'), ['/user/settings/networks']) ?>
        .
    </p>
</div>
