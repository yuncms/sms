...
/**
 * This is the ActiveQuery class for [[DatabaseNotification]].
 *
 * @see DatabaseNotification
 */
class DatabaseNotificationQuery extends \yii\db\ActiveQuery
{
    ...
    /*public function active()
    {
        return $this->andWhere(['status' => DatabaseNotification::STATUS_PUBLISHED]);
    }*/

    /**
     * @inheritdoc
     * @return DatabaseNotification[]|array
     */
